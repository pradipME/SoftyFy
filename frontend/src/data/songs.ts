...
export const SONGS: Song[] = [
  ...
  // ── Rap ─────────────────────────────────────────────────────────────────
  {
    ...
    album: 'Rap',
    durationSec: 186,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/i-guess.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1PCXb0zF__Dz1VBtckZffVRvgbtrnSUGz&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'no-cap',
    ...
    album: 'Rap',
    durationSec: 218,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/no-cap.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=16_5ghOy83cefD_hKKd_l_6uJSaVt0Mdz&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'untitled',
    ...
    album: 'Rap',
    durationSec: 167,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/untitled.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=19A3VFEKy_9a-m6Lw63B4OYN2bgyBsayl&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'freeverse-feast-langar',
    title: 'Freeverse Feast (Langar)',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 199,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/freeverse-feast-langar.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1E88JzkyYd8FH0udFc66Whp3NfU6GoZaN&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'blowing-up',
    ...
    album: 'Rap',
    durationSec: 257,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/blowing-up.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1Oaoz6IHsxMPXs6CL0KhPxtxQRy8g3B6f&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'say-my-name-hindi',
    title: 'Say My Name (Hindi Version)',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 181,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/say-my-name-hindi.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1Du0MEZMZMh3hSuGq0WS5znjCbo0bVKAy&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'fall-off-extended',
    title: 'Fall Off (Extended)',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 164,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/fall-off-extended.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=17ot8P3ucuuS0PeH4I89z4rVAI-BGyA9u&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'living-legend',
    title: 'Living Legend',
    artist: 'KR$NA & Rashmeet Kaur',
    album: 'Rap',
    durationSec: 234,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/living-legend.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1yInMSirvrkliUXtKiemNwvNDVBd-BuW8&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'og',
    ...
    album: 'Rap',
    durationSec: 222,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/og.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1oC26DB1bOIwiXRC7IeNkBll0hTEUkZ5x&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'no-losses',
    ...
    album: 'Rap',
    durationSec: 247,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/no-losses.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=11OI5x936-BkXnjYrcGCdi_4dHpYh-wVK&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'say-my-name-english',
    title: 'Say My Name (English Version)',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 181,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/say-my-name-english.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1MpTU_cN7M7V9ssfYKvxE6oEtLZ4TUCg-&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'vyanjan',
    title: 'Vyanjan (Hindi Alphabetic Rap)',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 210,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/vyanjan.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=18kG2KPsOE2ZSQzbPXZxlkrQuEzWJutk-&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'saza-e-maut',
    ...
    album: 'Rap',
    durationSec: 182,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/saza-e-maut.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1Gey9W3UOWLUXLcS0IRcQs_wnkcNBkd2B&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'playground',
    title: 'Playground',
    artist: 'Hi-Rez, KR$NA & KXNG Crooked',
    album: 'Rap',
    durationSec: 280,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/playground.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1LSIqs51Sjx3U6xu6Jdvg9fMQ_5AI1YGi&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'alag',
    ...
    album: 'Rap',
    durationSec: 225,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/alag.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1TxlZZkN1uKgQZFc3HeeiQRCn2yu2SGPp&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'on',
    title: 'On',
    artist: 'Raja Kumari & KR$NA',
    album: 'Rap',
    durationSec: 157,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/on.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=16DTD9mPw9FlV1D4T1pfqqg4uT4gHqWwP&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'window-shopper-freestyle',
    title: 'Window Shopper Freestyle',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 138,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/window-shopper-freestyle.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1Hil0ihxlC1zKBh9OIxmyTi9GBkEClRNT&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'meri-baari',
    title: 'Meri Baari',
    artist: 'Kidshot & KR$NA',
    album: 'Rap',
    durationSec: 183,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/meri-baari.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1nv2hYkZWvimEkdhQIZgQFXmGS3qQfEl8&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'aadat',
    ...
    album: 'Rap',
    durationSec: 220,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/aadat.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1lOhl4QXh-3zpfYw2Bahl0ORnr6Oh6QC1&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'muqabla',
    ...
    album: 'Rap',
    durationSec: 277,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/muqabla.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1Q1UncpamXNtkhQUQPML4AaVp5lUlyVCu&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'jaanta-kyun',
    ...
    album: 'Rap',
    durationSec: 196,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/jaanta-kyun.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1rXnNauKEtP-9Tn9GsHeGUzIgLGPEAG99&sz=w1000',
    library: 'Rap',
  },
  {
    id: 'desi-wrap-up-2016',
    title: 'Desi Wrap Up 2016',
    artist: 'KR$NA',
    album: 'Rap',
    durationSec: 223,
    audioSrc: 'https://github.com/pradipME/SoftyFy/releases/download/softyfy-audio-v1/desi-wrap-up-2016.webm',
    coverSrc: 'https://drive.google.com/thumbnail?id=1JgNsan48b3GmDmQPur9qkiWjntMkenS6&sz=w1000',
    library: 'Rap',
  },
]
